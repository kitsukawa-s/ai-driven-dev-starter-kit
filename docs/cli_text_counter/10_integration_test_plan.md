...
- 対象ドキュメント: `docs/cli_text_counter/overview.md`
...
| feature | 参照ドキュメント |
|---|---|
| `text_counter` | `docs/cli_text_counter/features/text_counter/01_spec.md` |
...
- `overview.md` の「CLI引数で入力文字列を受け取る」に含まれる範囲であること
- `overview.md` の「文字数を標準出力へ表示する」に含まれる範囲であること
- `overview.md` の「担当しないこと」に含まれる単語数、行数、ファイル入力、対話式入力を試験対象にしていないこと
