...
- feature: `calculator`
- 関数名候補: `add_numbers`
- 状態: 20_spec.md 作成済み。次は 21_design.md を作成する
- 最終更新: 2026-05-18

## 作業メモ

- [x] feature 用の `tasks.md` を `calculator` 配下に配置済み
- [x] `docs/cli_simple_calculator/features/calculator/20_spec.md` を配置済み
- [x] `add_numbers` は feature 名ではなく、実装時の関数名候補として扱う
- [ ] `docs/cli_simple_calculator/features/calculator/21_design.md` を作成する
