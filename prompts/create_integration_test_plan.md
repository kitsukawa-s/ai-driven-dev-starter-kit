...
feature 単体の詳細ロジックは、各 feature の `04_test_plan.md` と単体テストで確認します。
...
- 作成または更新する結合試験計画: `docs/<command_or_app_name>/10_integration_test_plan.md`
...
- `AGENTS.md`
- `docs/templates/10_integration_test_plan_template.md`
...
2. `docs/templates/10_integration_test_plan_template.md` を確認してください
3. `docs/<command_or_app_name>/overview.md` を確認してください
...
8. `docs/templates/10_integration_test_plan_template.md` の見出し構成を維持して `10_integration_test_plan.md` を作成または更新してください
...
- overview.md の Boundary と矛盾していないかを見る
...
結合試験計画を作るには情報が不足している場合は、いきなり `10_integration_test_plan.md` を作成しないでください。
...
ただし、`overview.md`、`entrypoint.py`、feature の設計ドキュメントから明確に読み取れる場合は、それをもとに整理して構いません。

## 禁止事項

- 情報不足のまま `10_integration_test_plan.md` を作成しないでください
- `overview.md` と矛盾する結合試験計画を作成しないでください
...
- 結合試験計画の作成中に、entrypoint や feature 実装が結合試験しにくい構造だと判断した場合でも、勝手に `src/` を変更しないでください。
  変更が必要そうな場合は、テストしにくい理由、影響するファイル、見直し候補を `10_integration_test_plan.md` の未決事項または改善候補として記載してください。
