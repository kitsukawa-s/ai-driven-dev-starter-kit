...
利用者が指定した内容だけで機能仕様を作るには情報が不足している場合は、いきなり `01_spec.md` を作成しないでください。
...
4. `docs/templates/01_spec_template.md` を確認してください
5. 情報が不足している場合は、確認事項だけを提示してください
6. 情報がそろっている場合のみ、`docs/templates/01_spec_template.md` の見出し構成を維持して `01_spec.md` を作成または更新してください
